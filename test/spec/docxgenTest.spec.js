(function() {
  var env, fileNames, name, root, _i, _len;
  ...
  describe('Changing the parser', function() {
    it('should work with uppercassing', function() {
      ...
      xmlTemplater.parser = function(tag) {
        return {
          'get': function(scope) {
    ...
    return it('should work when setting from the DocXGen interface', function() {
      var Tags;
      Tags = {
        "first_name": "Hipp",
        "last_name": "Edgar",
  ...
  describe('Non Utf-8 characters', function() {
    ...
    return it('should still read full text after applying tags', function() {
      var fullText;
