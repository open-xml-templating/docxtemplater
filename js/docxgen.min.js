...
(function(){var t,e,n;n="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",n.ScopeManager=t=function(){function t(t,e,n,o,r){this.tags=t,this.scopePath=e,this.usedTags=n,this.currentScope=o,this.parser=r}return t.prototype.loopOver=function(t,e){var n,o,r,i,s;if(null!=this.get(t)){if("object"===this.getTypeOf(t))for(s=this.get(t),n=r=0,i=s.length;i>r;n=++r)o=s[n],e(o);return this.get(t)===!0?e(this.currentScope):void 0}},t.prototype.get=function(t){return this.currentScope[t]},t.prototype.getTypeOf=function(t){return typeof this.get(t)},t.prototype.getValueFromScope=function(t){var e,n,o;if(e=this.parser(t),n=e.get(this.currentScope),null!=n)if("string"==typeof n){if(this.useTag(t),o=n,-1!==o.indexOf("{")||-1!==o.indexOf("}"))throw"You can't enter { or  } inside the content of a variable"}else o="number"==typeof n?String(n):n;else this.useTag(t),o="undefined";return o},t.prototype.useTag=function(t){var e,n,o,r,i,s;for(o=this.usedTags,s=this.scopePath,e=r=0,i=s.length;i>r;e=++r)n=s[e],null==o[n]&&(o[n]={}),o=o[n];return""!==t?o[t]=!0:void 0},t}()}).call(this);
