...
(function(){var e,t,o;o="undefined"!=typeof global&&null!==global?global:window,t="undefined"!=typeof global&&null!==global?"node":"browser",e=e=function(){function e(e){this.xmlTemplater=e,this.imgMatches=[]}return e.prototype.findImages=function(){return this.imgMatches=DocUtils.preg_match_all(/<w:drawing[^>]*>.*?<\/w:drawing>/g,this.xmlTemplater.content),this},e.prototype.replaceImages=function(){var e,t,o,m,r;for(this.qr=[],r=this.imgMatches,t=o=0,m=r.length;m>o;t=++o)e=r[t],this.replaceImage(e,t);return this},e.prototype.imageSetter=function(e){return e.xmlTemplater.numQrCode--,e.xmlTemplater.DocxGen.setImage("word/media/"+e.imgName,e.data),e.xmlTemplater.DocxGen.qrCodeCallBack(e.num,!1)},e.prototype.replaceImage=function(e,o){var m,r,a,s,n,l,i,c,p;if(p=DocUtils.Str2xml('<?xml version="1.0" ?><w:document mc:Ignorable="w14 wp14" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape">'+e[0]+"</w:document>"),"browser"===t&&(c=p.getElementsByTagNameNS("*","blip")[0]),"node"===t&&(c=p.getElementsByTagName("a:blip")[0]),void 0===c)throw"tagRiD undefined !";if(n=c.getAttribute("r:embed"),s=this.xmlTemplater.DocxGen.imgManager.getImageByRid(n),null!==s){if("browser"===t&&(i=p.getElementsByTagNameNS("*","docPr")[0]),"node"===t&&(i=p.getElementsByTagName("wp:docPr")[0]),void 0===i)throw"tag undefine";if("Copie_"!==i.getAttribute("name").substr(0,6))return r=("Copie_"+this.xmlTemplater.imageId+".png").replace(/\x20/,""),this.xmlTemplater.DocxGen.qrCodeNumCallBack++,this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!0),a=this.xmlTemplater.DocxGen.imgManager.addImageRels(r,""),this.xmlTemplater.imageId++,this.xmlTemplater.DocxGen.setImage("word/media/"+r,s.data),i.setAttribute("name",""+r),c.setAttribute("r:embed","rId"+a),m=p.getElementsByTagNameNS("*","drawing")[0],void 0===m&&(m=p.getElementsByTagName("w:drawing")[0]),l=DocUtils.xml2Str(m),this.xmlTemplater.content=this.xmlTemplater.content.replace(e[0],l),this.xmlTemplater.numQrCode++,"browser"===t?(this.qr[o]=new DocxQrCode(s.asBinary(),this.xmlTemplater,r,this.xmlTemplater.DocxGen.qrCodeNumCallBack),this.qr[o].decode(this.imageSetter)):/\.png$/.test(s.name)?function(e){return function(t){var m,r,a,n,l;return m=JSZip.base64.encode(s.asBinary()),r=new Buffer(m,"base64"),l=new PNG(r),n=function(m){return l.decoded=m,e.qr[o]=new DocxQrCode(l,e.xmlTemplater,t,e.xmlTemplater.DocxGen.qrCodeNumCallBack),e.qr[o].decode(e.imageSetter)},a=l.decode(n)}}(this)(r):this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!1)}},e}(),o.ImgReplacer=e}).call(this);
