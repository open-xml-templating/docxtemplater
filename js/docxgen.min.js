...
(function(){var e,t,o;o="undefined"!=typeof global&&null!==global?global:window,t="undefined"!=typeof global&&null!==global?"node":"browser",e=e=function(){function e(e){this.xmlTemplater=e,this.imgMatches=[],this.xmlTemplater.numQrCode=0}return e.prototype.findImages=function(){return this.imgMatches=DocUtils.preg_match_all(/<w:drawing[^>]*>.*?<\/w:drawing>/g,this.xmlTemplater.content),this},e.prototype.replaceImages=function(){var e,t,o,r,m;for(this.qr=[],m=this.imgMatches,t=o=0,r=m.length;r>o;t=++o)e=m[t],this.replaceImage(e,t);return this},e.prototype.imageSetter=function(e){return e.xmlTemplater.numQrCode--,console.log(e.xmlTemplater.numQrCode),e.xmlTemplater.DocxGen.setImage("word/media/"+e.imgName,e.data),e.xmlTemplater.DocxGen.qrCodeCallBack(e.num,!1)},e.prototype.replaceImage=function(e,o){var r,m,a,n,s,l,i,c,d,p;if(p=DocUtils.Str2xml('<?xml version="1.0" ?><w:document mc:Ignorable="w14 wp14" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape">'+e[0]+"</w:document>"),"browser"===t&&(d=p.getElementsByTagNameNS("*","blip")[0]),"node"===t&&(d=p.getElementsByTagName("a:blip")[0]),void 0===d)throw new Error("tagRiD undefined !");if(l=d.getAttribute("r:embed"),s=this.xmlTemplater.DocxGen.imgManager.getImageByRid(l),null===s)throw new Error("oldFile undefined");if("browser"===t&&(c=p.getElementsByTagNameNS("*","docPr")[0]),"node"===t&&(c=p.getElementsByTagName("wp:docPr")[0]),void 0===c)throw new Error("tag undefined");if("Copie_"!==c.getAttribute("name").substr(0,6)){if(m=("Copie_"+this.xmlTemplater.imageId+".png").replace(/\x20/,""),this.xmlTemplater.DocxGen.qrCodeNumCallBack++,this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!0),n=this.xmlTemplater.DocxGen.imgManager.addImageRels(m,""),this.xmlTemplater.imageId++,this.xmlTemplater.DocxGen.setImage("word/media/"+m,s.data),c.setAttribute("name",""+m),d.setAttribute("r:embed","rId"+n),"browser"===t&&(r=p.getElementsByTagNameNS("*","drawing")[0]),"node"===t&&(r=p.getElementsByTagName("w:drawing")[0]),void 0===r)throw new Error("imageTag undefined");return i=DocUtils.xml2Str(r),this.xmlTemplater.content=this.xmlTemplater.content.replace(e[0],i),console.log(this.xmlTemplater.numQrCode),this.xmlTemplater.numQrCode++,"browser"===t?(this.qr[o]=new DocxQrCode(s.asBinary(),this.xmlTemplater,m,this.xmlTemplater.DocxGen.qrCodeNumCallBack),this.qr[o].decode(this.imageSetter)):/\.png$/.test(s.name)?function(e){return function(t){var r,m,a,n,l;return r=JSZip.base64.encode(s.asBinary()),m=new Buffer(r,"base64"),l=new PNG(m),n=function(r){return l.decoded=r,e.qr[o]=new DocxQrCode(l,e.xmlTemplater,t,e.xmlTemplater.DocxGen.qrCodeNumCallBack),e.qr[o].decode(e.imageSetter)},a=l.decode(n)}}(this)(m):(a={xmlTemplater:this.xmlTemplater,imgName:m,data:s.asBinary()},this.imageSetter(a))}},e}(),o.ImgReplacer=e}).call(this);
(function(){var t,e,a;a="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",t=t=function(){function t(t,a,r,l,n){if(this.xmlTemplater=a,this.imgName=null!=r?r:"",this.num=l,this.callback=n,this.data=t,void 0===this.data)throw new Error("data of qrcode can't be undefined");"browser"===e&&(this.base64Data=JSZip.base64.encode(this.data)),this.ready=!1,this.result=null}return t.prototype.decode=function(t){var a,r;this.callback=t,r=this,this.qr=new QrCode,this.qr.callback=function(){var t;return console.log(this.result),r.ready=!0,r.result=this.result,t=new r.xmlTemplater.currentClass(this.result,r.xmlTemplater.toJson()),t.applyTags(),r.result=t.content,r.searchImage()};try{return"browser"===e?this.qr.decode("data:image/png;base64,"+this.base64Data):this.qr.decode(this.data,this.data.decoded)}catch(l){return a=l,console.log(data.length),console.log("Exception"),console.log(a)}},t.prototype.searchImage=function(){var t,e,a;if("gen:"===this.result.substr(0,4))return t=function(e){return function(a){return e.data=a,e.callback(e,e.imgName,e.num),e.xmlTemplater.DocxGen.localImageCreator(e.result,t)}}(this);if(null===this.result||void 0===this.result||"error decoding QR Code"===this.result.substr(0,22))return this.callback(this,this.imgName,this.num);a=function(t){return function(e){return t.data=e,t.callback(t,t.imgName,t.num)}}(this);try{return DocUtils.loadDoc(this.result,{docx:!1,callback:a,async:!1})}catch(r){return e=r,console.log(e)}},t}(),a.DocxQrCode=t}).call(this);
