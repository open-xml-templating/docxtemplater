...
Make library compatible with angular-expressions 1.6.0 (upcoming release of angular-expressions).

Without this fix, getIdentifiers could fail returning some values when using filters.
...
We acknowledge an oversight in our release sequence: version 3.69.2 was issued
following 3.69.0, while version 3.69.1 was inadvertently not released.
