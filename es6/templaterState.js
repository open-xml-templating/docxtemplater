...
module.exports = class TemplaterState {
	...
	calcPosition(bracket) {
		return this.matches[bracket.numXmlTag].offset + this.offset[bracket.numXmlTag] + this.matches[bracket.numXmlTag].array[1].length + this.charactersAdded[bracket.numXmlTag] + bracket.numCharacter;
	}
