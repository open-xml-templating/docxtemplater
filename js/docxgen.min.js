...
(function(){var e,t,m;m="undefined"!=typeof global&&null!==global?global:window,t="undefined"!=typeof global&&null!==global?"node":"browser",e=e=function(){function e(e){this.xmlTemplater=e,this.imgMatches=[]}return e.prototype.findImages=function(){return this.imgMatches=DocUtils.preg_match_all(/<w:drawing[^>]*>.*?<\/w:drawing>/g,this.xmlTemplater.content),this},e.prototype.imageSetter=function(e){return e.xmlTemplater.numQrCode--,e.xmlTemplater.DocxGen.setImage("word/media/"+e.imgName,e.data),e.xmlTemplater.DocxGen.qrCodeCallBack(e.num,!1)},e.prototype.replaceImage=function(e,m){var r,o,a,l,s,i,n,c,p,d;if(d=DocUtils.Str2xml('<?xml version="1.0" ?><w:document mc:Ignorable="w14 wp14" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape">'+e[0]+"</w:document>"),this.xmlTemplater.DocxGen.qrCode){if(p=d.getElementsByTagNameNS("*","blip")[0],void 0===p&&(p=d.getElementsByTagName("a:blip")[0]),void 0!==p&&(i=p.getAttribute("r:embed"),s=this.xmlTemplater.DocxGen.imgManager.getImageByRid(i),null!==s&&(c=d.getElementsByTagNameNS("*","docPr")[0],void 0===c&&(c=d.getElementsByTagName("wp:docPr")[0]),void 0!==c&&"Copie_"!==c.getAttribute("name").substr(0,6))))return a=("Copie_"+this.xmlTemplater.imageId+".png").replace(/\x20/,""),this.xmlTemplater.DocxGen.qrCodeNumCallBack++,this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!0),l=this.xmlTemplater.DocxGen.imgManager.addImageRels(a,""),this.xmlTemplater.imageId++,this.xmlTemplater.DocxGen.setImage("word/media/"+a,s.data),c.setAttribute("name",""+a),p.setAttribute("r:embed","rId"+l),r=d.getElementsByTagNameNS("*","drawing")[0],void 0===r&&(r=d.getElementsByTagName("w:drawing")[0]),n=DocUtils.xml2Str(r),this.xmlTemplater.content=this.xmlTemplater.content.replace(e[0],n),this.xmlTemplater.numQrCode++,"browser"===t?(this.qr[m]=new DocxQrCode(s.asBinary(),this.xmlTemplater,a,this.xmlTemplater.DocxGen.qrCodeNumCallBack),this.qr[m].decode(this.imageSetter)):/\.png$/.test(s.name)?function(e){return function(t){var r,o,a,l,i;return r=JSZip.base64.encode(s.asBinary()),o=new Buffer(r,"base64"),i=new PNG(o),l=function(r){return i.decoded=r,e.qr[m]=new DocxQrCode(i,e.xmlTemplater,t,e.xmlTemplater.DocxGen.qrCodeNumCallBack),e.qr[m].decode(e.imageSetter)},a=i.decode(l)}}(this)(a):this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!1)}else if(null!=this.xmlTemplater.currentScope.img&&null!=this.xmlTemplater.currentScope.img[m]){if(a=this.xmlTemplater.currentScope.img[m].name,o=this.xmlTemplater.currentScope.img[m].data,null==this.xmlTemplater.DocxGen)throw"DocxGen not defined";if(l=this.xmlTemplater.DocxGen.imgManager.addImageRels(a,o),c=d.getElementsByTagNameNS("*","docPr")[0],void 0===c&&(c=d.getElementsByTagName("wp:docPr")[0]),void 0!==c&&(this.xmlTemplater.imageId++,c.setAttribute("id",this.xmlTemplater.imageId),c.setAttribute("name",""+a),p=d.getElementsByTagNameNS("*","blip")[0],void 0===p&&(p=d.getElementsByTagName("a:blip")[0]),void 0!==p))return p.setAttribute("r:embed","rId"+l),r=d.getElementsByTagNameNS("*","drawing")[0],void 0===r&&(r=d.getElementsByTagName("w:drawing")[0]),this.xmlTemplater.content=this.xmlTemplater.content.replace(e[0],DocUtils.xml2Str(r))}},e.prototype.replaceImages=function(){var e,t,m,r,o;for(this.qr=[],o=this.imgMatches,t=m=0,r=o.length;r>m;t=++m)e=o[t],this.replaceImage(e,t);return this},e}(),m.ImgReplacer=e}).call(this);
...
(function(){var t,e,o;o="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",o.ScopeManager=t=function(){function t(t,e,o,n,r){this.tags=t,this.scopePath=e,this.usedTags=o,this.currentScope=n,this.parser=r}return t.prototype.loopOver=function(t,e){var o,n,r,i,s;if(null!=this.get(t)){if("object"===this.getTypeOf(t))for(s=this.get(t),o=r=0,i=s.length;i>r;o=++r)n=s[o],e(n);return this.get(t)===!0?e(this.currentScope):void 0}},t.prototype.get=function(t){return this.currentScope[t]},t.prototype.getTypeOf=function(t){return typeof this.get(t)},t.prototype.getValueFromScope=function(t){var e,o,n;if(e=this.parser(t),o=e.get(this.currentScope),null!=o)if("string"==typeof o){if(this.useTag(t),n=o,-1!==n.indexOf("{")||-1!==n.indexOf("}"))throw"You can't enter { or  } inside the content of a variable"}else n=o;else this.useTag(t),n="undefined";return n},t.prototype.useTag=function(t){var e,o,n,r,i,s;for(n=this.usedTags,s=this.scopePath,e=r=0,i=s.length;i>r;e=++r)o=s[e],null==n[o]&&(n[o]={}),n=n[o];return""!==t?n[t]=!0:void 0},t}()}).call(this);
(function(){var t,e,s;s="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",s.SubContent=t=function(){function t(t){this.fullText=null!=t?t:"",this.text="",this.start=0,this.end=0}return t.prototype.getInnerTag=function(t){return this.start=t.calcPosition(t.tagStart),this.end=t.calcPosition(t.tagEnd)+1,this.refreshText()},t.prototype.refreshText=function(){return this.text=this.fullText.substr(this.start,this.end-this.start),this},t.prototype.getOuterXml=function(t){if(this.end=this.fullText.indexOf("</"+t+">",this.end),-1===this.end)throw"can't find endTag "+this.end;if(this.end+=("</"+t+">").length,this.start=Math.max(this.fullText.lastIndexOf("<"+t+">",this.start),this.fullText.lastIndexOf("<"+t+" ",this.start)),-1===this.start)throw"can't find startTag";return this.refreshText()},t.prototype.replace=function(t){return this.fullText=this.fullText.substr(0,this.start)+t+this.fullText.substr(this.end),this.end=this.start+t.length,this.refreshText()},t}()}).call(this);