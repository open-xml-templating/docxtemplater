 ...
 * @param  {[type]} start =             0             [description]
 * @param  {[type]} end   =             text.length-1 [description]
 * @return {Array}  [{"tag":"</w:r>","offset":13},{"tag":"</w:p>","offset":265},{"tag":"</w:tc>","offset":271},{"tag":"<w:tc>","offset":828},{"tag":"<w:p>","offset":883},{"tag":"<w:r>","offset":1483}]
###
...
###*
 * it returns the difference between two scopes, ie simplifyes closes and opens. If it is not null, 
 * it means that the beginning is for example in a table, and the second one is not. If you hard copy this text, the XML will  break
 * @param  {[type]} text  [description]
 * @param  {[type]} start =             0           [description]
 * @param  {[type]} end   =             text.length -             1 [description]
 * @return {[type]}       [description]
###
XmlUtil.getListDifferenceXmlElements = (text, start = 0, end = text.length - 1) ->
