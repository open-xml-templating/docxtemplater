...
(function(){var e,t,r;r="undefined"!=typeof global&&null!==global?global:window,t="undefined"!=typeof global&&null!==global?"node":"browser",e=e=function(){function e(e){this.xmlTemplater=e,this.imgMatches=[],this.xmlTemplater.numQrCode=0}return e.prototype.findImages=function(){return this.imgMatches=DocUtils.preg_match_all(/<w:drawing[^>]*>.*?<\/w:drawing>/g,this.xmlTemplater.content),this},e.prototype.replaceImages=function(){var e,t,r,m,o;for(this.qr=[],o=this.imgMatches,t=r=0,m=o.length;m>r;t=++r)e=o[t],this.replaceImage(e,t);return this},e.prototype.imageSetter=function(e){return e.xmlTemplater.numQrCode--,e.xmlTemplater.DocxGen.setImage("word/media/"+e.imgName,e.data),e.xmlTemplater.DocxGen.qrCodeCallBack(e.num,!1)},e.prototype.replaceImage=function(e,r){var m,o,a,n,s,i,l,c,p;if(p=DocUtils.Str2xml('<?xml version="1.0" ?><w:document mc:Ignorable="w14 wp14" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w14="http://schemas.microsoft.com/office/word/2010/wordml" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:wp14="http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing" xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:wpg="http://schemas.microsoft.com/office/word/2010/wordprocessingGroup" xmlns:wpi="http://schemas.microsoft.com/office/word/2010/wordprocessingInk" xmlns:wps="http://schemas.microsoft.com/office/word/2010/wordprocessingShape">'+e[0]+"</w:document>"),"browser"===t&&(c=p.getElementsByTagNameNS("*","blip")[0]),"node"===t&&(c=p.getElementsByTagName("a:blip")[0]),void 0===c)throw new Error("tagRiD undefined !");if(s=c.getAttribute("r:embed"),n=this.xmlTemplater.DocxGen.imgManager.getImageByRid(s),null===n)throw new Error("oldFile undefined");if("browser"===t&&(l=p.getElementsByTagNameNS("*","docPr")[0]),"node"===t&&(l=p.getElementsByTagName("wp:docPr")[0]),void 0===l)throw new Error("tag undefined");if("Copie_"!==l.getAttribute("name").substr(0,6)){if(o=("Copie_"+this.xmlTemplater.imageId+".png").replace(/\x20/,""),this.xmlTemplater.DocxGen.qrCodeNumCallBack++,this.xmlTemplater.DocxGen.qrCodeCallBack(this.xmlTemplater.DocxGen.qrCodeNumCallBack,!0),a=this.xmlTemplater.DocxGen.imgManager.addImageRels(o,""),this.xmlTemplater.imageId++,this.xmlTemplater.DocxGen.setImage("word/media/"+o,n.data),l.setAttribute("name",""+o),c.setAttribute("r:embed","rId"+a),"browser"===t&&(m=p.getElementsByTagNameNS("*","drawing")[0]),"node"===t&&(m=p.getElementsByTagName("w:drawing")[0]),void 0===m)throw new Error("imageTag undefined");return i=DocUtils.xml2Str(m),this.xmlTemplater.content=this.xmlTemplater.content.replace(e[0],i),this.xmlTemplater.numQrCode++,"browser"===t?(this.qr[r]=new DocxQrCode(n.asBinary(),this.xmlTemplater,o,this.xmlTemplater.DocxGen.qrCodeNumCallBack),this.qr[r].decode(this.imageSetter)):/\.png$/.test(n.name)?function(e){return function(t){var m,o,a,s,i;return m=JSZip.base64.encode(n.asBinary()),o=new Buffer(m,"base64"),i=new PNG(o),s=function(m){var o;i.decoded=m;try{return e.qr[r]=new DocxQrCode(i,e.xmlTemplater,t,e.xmlTemplater.DocxGen.qrCodeNumCallBack),e.qr[r].decode(e.imageSetter)}catch(a){return o=a,console.log(o),setTimeout(function(){var r;return r={xmlTemplater:e.xmlTemplater,imgName:t,data:n.asBinary()},e.imageSetter(r)},200)}},a=i.decode(s)}}(this)(o):setTimeout(function(e){return function(){var t;return t={xmlTemplater:e.xmlTemplater,imgName:o,data:n.asBinary()},e.imageSetter(t)}}(this),200)}},e}(),r.ImgReplacer=e}).call(this);
(function(){var t,e,a;a="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",t=t=function(){function t(t,a,r,s,l){if(this.xmlTemplater=a,this.imgName=null!=r?r:"",this.num=s,this.callback=l,this.data=t,void 0===this.data)throw new Error("data of qrcode can't be undefined");"browser"===e&&(this.base64Data=JSZip.base64.encode(this.data)),this.ready=!1,this.result=null}return t.prototype.decode=function(t){var a;return this.callback=t,a=this,this.qr=new QrCode,this.qr.callback=function(){var t;return a.ready=!0,a.result=this.result,t=new a.xmlTemplater.currentClass(this.result,a.xmlTemplater.toJson()),t.applyTags(),a.result=t.content,a.searchImage()},"browser"===e?this.qr.decode("data:image/png;base64,"+this.base64Data):this.qr.decode(this.data,this.data.decoded)},t.prototype.searchImage=function(){var t,e,a;if("gen:"===this.result.substr(0,4))return t=function(e){return function(a){return e.data=a,e.callback(e,e.imgName,e.num),e.xmlTemplater.DocxGen.localImageCreator(e.result,t)}}(this);if(null===this.result||void 0===this.result||"error decoding QR Code"===this.result.substr(0,22))return this.callback(this,this.imgName,this.num);a=function(t){return function(e){return t.data=e,t.callback(t,t.imgName,t.num)}}(this);try{return DocUtils.loadDoc(this.result,{docx:!1,callback:a,async:!1})}catch(r){return e=r,console.log(e)}},t}(),a.DocxQrCode=t}).call(this);
